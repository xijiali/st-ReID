...
parser.add_argument('--name',default='ft_ResNet50_pcb_duke_e_gs', type=str, help='0,1,2,3...or last')
...
result = scipy.io.loadmat('model_4/'+name+'/'+'pytorch_result_gs.mat')
print(result)
...
result2 = scipy.io.loadmat('model_4/'+name+'/'+'pytorch_result2_gs.mat')
...
scipy.io.savemat('model_4/'+name+'/'+'CMC_duke_two_stream_add'+str(alpha)+'.mat',result)
