...
import time
import os
from model import ft_net, ft_net_dense, PCB_gs_3
...
parser.add_argument('--name', default='ft_ResNet50_pcb_duke_e_gs', type=str, help='output model name')
        ...
        for phase in ['train', 'val']:
            ...
            for data in dataloaders[phase]:
                ...
                if not opt.PCB:
                    ...
                    weight=sig(part[0])*sig(part[1])*sig(part[2])
...
def save_network(network, epoch_label):
    ...
    save_path = os.path.join('./model_4', name, save_filename)
...
if opt.PCB:
    model = PCB_gs_3(len(class_names))
...
#
dir_name = os.path.join('./model_4', name)
