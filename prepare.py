...
download_path = "/gruntdata/xiaoxi.xjl/re_id_datasets/Market-1501-v15.09.15/"

parser = argparse.ArgumentParser(description='prepare')
parser.add_argument('--Market', default=True, help='prepare dataset market1501')
parser.add_argument('--Duke', default=False, help='prepare dataset Duke-MTMC')
