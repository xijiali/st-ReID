...
parser.add_argument('--save-name', default='ft_ResNet50_pcb_duke_e_results.mat', type=str, help='save model path')
...
scipy.io.savemat('model_2/'+name+'/'+'pytorch_result.mat',result)
