...
parser.add_argument('--data_dir',default="./dataset/DukeMTMC_prepare/",type=str, help='./train_data')
...
scipy.io.savemat('./model_4/'+name+'/'+'pytorch_result2_gs.mat',result)
#/gruntdata/xiaoxi.xjl/my_code/st_ReID/model/ft_ResNet50_pcb_duke_e